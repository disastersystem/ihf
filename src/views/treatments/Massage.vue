    ...
    meta: [
      {
        ...
        content: `Øk velvære og avspenning, og reduser stressreaksjoner. Klassisk massasje, Idrettsmassasje, Lymfedrenasje, Gravidmassasje, Bindevevsmassasje`
      },
      {
        rel: 'canonical',
        href: 'https://innlandethelseogfysioterapi.no/massasje'
      }
    ]
  },
